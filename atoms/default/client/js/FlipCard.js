                ...
                <div class="card-body">
                    ...
                    <div class="back">
                        <div class="content">
                            ...
                            <div className="content-wrap">
                                <div>
                                    <div className="back-img" style={{backgroundImage: `url(${assetsPath}/back_0${props.id}.png)`}} />
                                    <div className="text-wrap" dangerouslySetInnerHTML={{__html: props.back}}></div>
                    ...
                    <a name={`card${props.id}`} class="front" onclick={this.handeClick.bind(this)}>
                        <div class="content" style={{
                            ...
                            backgroundImage: ` url(<%= path %>/${props.image})`
                        }}>
                            {/* <div class="border"></div> */}
